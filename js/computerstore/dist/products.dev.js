...
function onedit(tr) {
  ...
  document.getElementById("countid").value = selecteditem.cells[6].innerHTML; //document.getElementById("priceid").value = selecteditem.cells[9].innerHTML;
...
function resetform() {
  ...
  document.getElementById("countid").value = ""; //document.getElementById("priceid").value="";
